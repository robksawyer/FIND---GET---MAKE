...
<?php
	//echo $this->element('top_actions',array('item'=>$contractorSpecialty,'model'=>'ContractorSpecialty','cache'=>false));
?>
<h2><?php  __($contractorSpecialty['ContractorSpecialty']['name']);?></h2>
