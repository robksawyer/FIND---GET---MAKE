<div style="padding:15px 0 100px 0;background:#ececec;width:100%;margin:0 0 0 0;color:#000000;">
	<div style="width:516px;background:white;margin:15px auto;overflow:auto;font-family:'helvetica'">
		...
		<div style="width:440px;margin:0 auto">
			...
			?>
			<h1 style="font-size:20px;margin:40px 0 20px 0;color:#000000;"><?php echo $this->Html->link($user_name,Router::url(array('ajax'=>false,'controller'=>'users','action'=>'profile',$user['User']['username']),true),array('style'=>'color:#ef3f23')); ?> <?php echo $ownership_type_nicename; ?> the product <?php echo $this->Html->link($product['Product']['name'],Router::url(array('ajax'=>false,'plugin'=>'','controller'=>'products','action'=>'view',$product['Product']['id']),true),array('style'=>'color:#ef3f23')); ?>.</h1>
			<div style="position:relative;text-align: center;">
			<?php
			//Show the image of the product
			if(!empty($product['Attachment'])):
			$imagePath = Router::url($product['Attachment'][0]['path_med'],true);
			echo $this->Html->image($imagePath,array('url'=>Router::url(array('ajax'=>false,'plugin'=>'','controller'=>'products','action'=>'view',$product['Product']['id']),true),
