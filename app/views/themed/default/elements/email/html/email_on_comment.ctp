<div style="padding:15px 0 100px 0;background:#ececec;width:100%;margin:0 0 0 0;color:#000000;">
	<div style="width:516px;background:white;margin:15px auto;overflow:auto;font-family:'helvetica'">
		...
		<div style="width:440px;margin:0 auto">
			...
			?>
			<h1 style="font-size:20px;margin:40px 0 20px 0;color:#000000;"><?php echo $this->Html->link($user_name,Router::url(array('ajax'=>false,'controller'=>'users','action'=>'profile',$user['User']['username']),true),array('style'=>'color:#ef3f23')); ?> commented on the product <?php echo $this->Html->link($item['Product']['name'],Router::url(array('ajax'=>false,'plugin'=>'','controller'=>'products','action'=>'view',$item['Product']['id']),true),array('style'=>'color:#ef3f23')); ?>.</h1>
			...
			<?php if(!empty($data)): ?>
			<div style="position:relative;text-align: center;margin-top:20px; font-size: 13px; background: whiteSmoke; color: #000000; text-align: left; padding: 10px;">
				<?php 
					echo $user_name." said, <br/>";
					echo '<span style="">&quot;</span>'.$data['Comment']['body'].'<span style="">&quot;</span>'; 
				?>
			</div>
			<?php endif; ?>
