<div class="haves moderate">
	<div class="header grey"><?php __('Products owned by you');?></div>
	<?php
	if(!empty($products)):
	?>
	<!-- Start gridded items -->
	<div id="grid-container-have-products">
	<?php
	$i = 0;
	...
	<?php else: ?>
		<div class="missing-content"><p>Navigate to a product. Click <i>+add to list</i> under a product image, and select Have list to make products appear here.<p></div>
	<?php
	endif;
	?>
</div>
...
$(function(){
	var $container = $("#grid-container-have-products");
