...
/* ContractorType Test cases generated on: 2011-07-07 20:23:57 : 1310095437*/
App::import('Model', 'ContractorType');

class ContractorTypeTestCase extends CakeTestCase {
	...
	function startTest() {
		$this->ContractorType =& ClassRegistry::init('ContractorType');
	}
