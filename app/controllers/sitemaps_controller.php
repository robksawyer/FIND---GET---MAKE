...
class SitemapsController extends AppController{ 
	 ...
	 */ 
	function __get_data() { 
		ClassRegistry::init('Source')->recursive = false; 
		$this->__add_dynamic_section( 
							 'Source',  
							 ClassRegistry::init('Source')->find('all', 
																	array(
																		'fields' => array('id', 'modified', 'name'),
																		'limit' => 500,
																		'order'=>'Source.modified DESC'
																		)),  
							 array( 
									'controllertitle' => 'The Sources', 
									'fields' => array('title' => 'name', 'date' => false), 
									'changefreq' => 'daily', 
									'pr' => '1.0',	
									'url' => array('controller' => 'sources', 'action' => 'view') 
								   ) 
							 );			
		...
		ClassRegistry::init('Product')->recursive = false; 
		$this->__add_dynamic_section( 
							 'Product',	 
							 ClassRegistry::init('Product')->find('all', array(
																				'fields' => array('id','modified', 'name'),
																				'limit' => 500,
																				'order'=>'Product.modified DESC'
																				)),  
							 array( 
									'controllertitle' => 'Products', 
									'fields' => array('title' => 'name', 'date' => false), 
									'pr' => '0.7',	
									'changefreq' => 'weekly', 
