 ...
 */
	if(!defined('LOG_ERROR')) define('LOG_ERROR', 2);
 ...
 */
	Configure::write('Session.cookie', 'FindGetMake');
 ...
 */
	Configure::write('Security.salt', '3245aASDFASDF4354@#@SDFSFSDFS#@##$SAS:{::ASD   SDFASD}');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '23423487897293845723948573298752435');
